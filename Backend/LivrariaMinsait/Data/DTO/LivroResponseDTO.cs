...
namespace LivrariaMinsait.Data.DTO
{
    ...
    {
        public LivroResponseDTO(int id, string titulo, string? subTitulo, string? resumo, int qtdePaginas, string dataPublicacao, string editora, int? edicao, List<string> autor)
        {
            Id=id;
            Titulo=titulo;
            SubTitulo=subTitulo;
